...
const Contact = () => {
  ...
  return (
    <div className="bg-razaq-cream-50 min-h-screen">
      {/* Hero Section */}
      <div className="relative h-64 md:h-80 bg-razaq-green-900 overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-razaq-green-200 rounded-md focus:outline-none focus:ring-2 focus:ring-razaq-green-300"
              ...
              <Button 
                type="submit" 
                className="w-full bg-razaq-green hover:bg-razaq-green-600" 
          ...
          <div className="space-y-8 animated-element">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-base">123 Anarkali Market,</p>
                    <p className="text-base">Lahore, Punjab, Pakistan</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-8">
              ...
              <div className="aspect-video rounded-md overflow-hidden">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13611.284535434327!2d74.3070354754277!3d31.5843298536692!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39191aa6bd1a2f33%3A0xc35cae32c7a50374!2sAnarkali%20Bazaar!5e0!3m2!1sen!2s!4v1634567890000!5m2!1sen!2s" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm animated-element">
